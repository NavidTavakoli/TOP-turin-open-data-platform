...
export const onRequest: PagesFunction<Env> = async (ctx) => {
  ...
  try {
    ...
    // If api.vw_traffic_top_jams is missing, this call fails and the catch block returns an empty list.
    ...
    // Return an empty list in the public demo so the UI remains available.
    // Avoid exposing internal database details in the public demo response.
